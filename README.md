...
```
python detect.py images 0.5 0.5 data/images/dog.jpg data/images/image1.jpg
```
...
*[Yolo v3 Object Detection in Tensorflow](https://www.kaggle.com/aruchomu/yolo-v3-object-detection-in-tensorflow)
